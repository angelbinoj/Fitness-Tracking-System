...
export default function Navbar() {
  return (
    ...
    <nav className="p-2 h-28 md:p-4 flex justify-between bg-gradient-to-br from-[#0f5707] to-[#159307] ">
      <div className='w-full grid grid-cols-2 md:grid-cols-[40%_60%]  lg:grid-cols-[45%_55%] '>
         <ThemeToggle className='fixed top-1 left-1'/>
        <div className='text-center mt-4 md:mt-0 flex justify-center items-center'>
          <h1 className='logo'>ElevFit</h1>
        </div>
        <div className='flex justify-around items-center text-center ps-10 mt-3 md:mt-0 text-base lg:text-lg'>
