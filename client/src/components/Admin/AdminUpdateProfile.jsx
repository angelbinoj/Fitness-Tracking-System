...
function AdminUpdateProfile() {
  ...
  return (
    <div className="flex justify-center items-center py-4 px-4  min-h-screen">
      <div className="flex flex-col mx-auto items-center bg-white dark:bg-green-50 shadow-lg border border-green-300 rounded-lg font-medium w-full sm:w-4/5 lg:w-2/3 xl:w-1/2 p-8">
