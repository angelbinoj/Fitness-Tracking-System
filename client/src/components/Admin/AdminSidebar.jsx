...
export default function AdminSidebar(){
    ...
    return(
        ...
        <div className='flex flex-col gap-3 uppercase'>
            <span onClick={()=>navigate("/admin/dashboard")} className='w-full py-3 bg-[#ddf600] hover:bg-[#ebff3a] text-slate-900 font-semibold hover:font-bold  text-lg text-center'>dashboard</span>
            {navLink.map((item)=>(
