...
const BookSession = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-green-50 p-4 md:p-8">
            {sessions.length === 0 ? (
                <div className="bg-green-100 p-6 h-full flex justify-center items-center rounded-xl shadow-md">
                    <div className="w-full md:w-2/3 p-10 rounded-xl flex flex-col bg-white border border-green-200 shadow-xl text-center">
                        <h2 className="text-3xl font-bold text-green-800">No Upcoming Sessions!</h2>
                ...
                <div className="w-full md:w-4/5 lg:w-3/5 mx-auto mt-6">
                    {message && (
                        <div className="bg-green-200 text-green-800 px-4 py-2 rounded mb-4 text-center font-medium shadow">
                            {message}
                        </div>
                    )}

                    <div className="w-full flex justify-between items-center">
                        <h1 className="text-3xl font-bold mb-5 text-green-800 text-center md:text-left">
                        Available Sessions
                    </h1>
        <button onClick={()=>navigate("/user/sessionCalender")} className="bg-green-600 px-4 py-2 rounded text-white hover:bg-green-500">View Session Calendar</button>
      </div>

                    <div className="overflow-x-auto shadow-lg">
                        <table className="min-w-full bg-white">
                            <thead>
                                <tr className="bg-green-300 text-center text-green-900">
                                        ...
                                        <tr key={s._id} className="text-center hover:bg-green-50 transition">
                                            ...
                                            <td className="border border-green-600 px-3 py-2">
                                                <button
                                                    ...
                                                    disabled={isBooked}
                                                    className={`px-4 py-2 rounded font-medium shadow-md transition ${
                                                        isBooked
